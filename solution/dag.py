...
#   3. Transform — read the raw JSON, clean and reshape the records, then
#                  write the result back to S3 as CSV under a processed prefix
#   4. Load      — use S3ToRedshiftOperator to upsert the processed CSV
